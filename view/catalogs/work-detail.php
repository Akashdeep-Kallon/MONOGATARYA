                        ...
                        <ul class="chapter-list" aria-label="Lista de capítulos">
                            <?php foreach ($chapters as $ch) {
                                ...
                                <li class="chapter-row">
                                    ...
                                    <?php if (isPromoter()) { ?>
                                        <a class="chapter-edit-btn"
                                            href="edit-chapter.php?type=<?php echo urlencode($type); ?>&id=<?php echo $id; ?>&idChapter=<?php echo $chId; ?>&numberChapter=<?php echo $chNum; ?>"
                                            aria-label="Editar capítulo <?php echo $chNum; ?>">
                                            <svg class="icon" aria-hidden="true">
                                                <use href="<?php echo ASSETS_URL; ?>/img/icon-sprites.svg#edit"></use>
                                            </svg>
                                        </a>
                                    <?php } ?>
                                </li>
